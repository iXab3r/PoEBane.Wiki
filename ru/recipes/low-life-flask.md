...
[Модель исполнения и примитивы ожидания](../scripting/execution-and-waits.md) объясняет Sleep без await, независимые правила, WaitUntil и Stop. [Рецепты ожидания](waiting.md) показывают последовательную обработку и движение за лидером. Эти возможности POE-81 пока не выпущены; проверяйте объявления установленной версии.
